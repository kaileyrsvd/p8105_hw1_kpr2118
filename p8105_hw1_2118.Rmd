...
The code chunk attempts to find the mean of each variable. For purposes of clarity, results are hidden but are described below. 

```{r Variable_Means, results='hide', message=FALSE, warning=FALSE}
